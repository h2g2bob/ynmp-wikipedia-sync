...
csv_headers = [u'constituency_name', u'eu_region', u'county', u'party', u'party_2015',
	u'gender_male', u'gender_female', u'gender_other', u'gender_undefined',
	u'party_2010_only', u'party_2010_and_2015', u'party_2015_only',
...
def write_csv_line(csvfile, constituency_name, eu_region, county, stats):
	...
	parties = set(sum(
		(stats.get(stat_name, {}).keys() for stat_name in csv_headers[4:]),
		[]))
